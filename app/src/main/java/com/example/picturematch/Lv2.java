...
public class Lv2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            case "Birds":
                drawanle = new int[]{R.drawable.bird1, R.drawable.bird2, R.drawable.bird3} ;
                break;
            case "Cats":
                drawanle = new int[]{R.drawable.cat1, R.drawable.cat2, R.drawable.cat3} ;
                break;
            case "Dogs":
                drawanle = new int[]{R.drawable.dog1, R.drawable.dog2,R.drawable.dog3} ;
                break;
            case "Trees":
                drawanle = new int[]{R.drawable.tree1, R.drawable.tree2,R.drawable.tree3} ;
                break;
            default:
                drawanle = new int[]{R.drawable.tree1, R.drawable.dog2,R.drawable.cat3};
                break;
        }
...
//                                                        if(Collections.frequency(posDeja,drawanle[pos.get(position)])<1)
                                                        ...
                                                        if(cuerentPair==3){
                                                            ...
                                                            mDatabase.execSQL("UPDATE joueur SET niveau =2 WHERE id= "+(cle)+"; ");
                                                            mDatabase.close();
                                                            /*  */
                                                            ...
                                                            i.putExtra("passToLevel3",true);
                                                            i.putExtra("idd",cle);
                                                            end = System.currentTimeMillis();
                                                            mDatabase = openOrCreateDatabase(DATABASE_NAME, MODE_PRIVATE, null);
                                                            Cursor cursorJoueur = mDatabase.rawQuery("SELECT scor FROM joueur where id = "+Integer.parseInt(cle)+";", null);
                                                            if (cursorJoueur.moveToFirst()) {
                                                                ...
                                                                Toast.makeText(Lv2.this, String.valueOf(oldScore + (end - start)), Toast.LENGTH_SHORT).show();
                                                            }
                                                            try{
