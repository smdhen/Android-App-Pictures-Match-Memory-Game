...
public class Lv3 extends AppCompatActivity {
    ...
    int [] drawanle;
    ArrayList<Integer> pos = new  ArrayList<Integer>(Arrays.asList(0,1,2,3,0,1,2,3));
    int cuerentpos =-1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            case "Birds":
                drawanle = new int[]{R.drawable.bird1, R.drawable.bird2, R.drawable.bird3,R.drawable.bird4} ;
                break;
            case "Cats":
                drawanle = new int[]{R.drawable.cat1, R.drawable.cat2, R.drawable.cat3, R.drawable.cat4} ;
                break;
            case "Dogs":
                drawanle = new int[]{R.drawable.dog1, R.drawable.dog2,R.drawable.dog3, R.drawable.dog4} ;
                break;
            case "Trees":
                drawanle = new int[]{R.drawable.tree1, R.drawable.tree2,R.drawable.tree3, R.drawable.tree4} ;
                break;
            default:
                drawanle = new int[]{R.drawable.tree1, R.drawable.dog2,R.drawable.cat3, R.drawable.bird4};
                break;
        }
        ...
        GridView gridView=(GridView) findViewById(R.id.grlv3);
...
//                                                        if(Collections.frequency(posDeja,drawanle[pos.get(position)])<1)
                                                        ...
                                                        if(cuerentPair==4){
                                                            ...
                                                            mDatabase.execSQL("UPDATE joueur SET niveau =3 WHERE id= "+Integer.parseInt(cle)+" ; ");
                                                            mDatabase.close();
                                                            /*  */
