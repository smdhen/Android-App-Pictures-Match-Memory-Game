...
public class Lv3Guest extends AppCompatActivity {


    ImageView imageView=null;
    private int cuerentPair=0;
    int [] drawanle = new int[]{R.drawable.tree1, R.drawable.dog2,R.drawable.cat3, R.drawable.bird4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lv3_guest);
