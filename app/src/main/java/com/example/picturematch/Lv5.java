...
public class Lv5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            case "Birds":
                drawanle = new int[]{R.drawable.bird1, R.drawable.bird2, R.drawable.bird3,R.drawable.bird4,R.drawable.bird5,R.drawable.bird6} ;
                break;
            case "Cats":
                drawanle = new int[]{R.drawable.cat1, R.drawable.cat2, R.drawable.cat3, R.drawable.cat4, R.drawable.cat5, R.drawable.cat6} ;
                break;
            case "Dogs":
                drawanle = new int[]{R.drawable.dog1, R.drawable.dog2,R.drawable.dog3, R.drawable.dog4, R.drawable.dog5, R.drawable.dog6} ;
                break;
            case "Trees":
                drawanle = new int[]{R.drawable.tree1, R.drawable.tree2,R.drawable.tree3, R.drawable.tree4, R.drawable.tree5, R.drawable.tree6} ;
                break;
            default:
                drawanle = new int[]{R.drawable.tree1, R.drawable.dog2,R.drawable.cat3, R.drawable.bird4, R.drawable.im1, R.drawable.im2};
                break;
        }
...
//                                                        if(Collections.frequency(posDeja,drawanle[pos.get(position)])<1)
                                                        ...
                                                        if(cuerentPair==6){
                                                            ...
                                                            mDatabase.execSQL("UPDATE joueur SET niveau =5 WHERE id= "+Integer.parseInt(cle)+" ; ");
                                                            mDatabase.close();
                                                            /*  */
